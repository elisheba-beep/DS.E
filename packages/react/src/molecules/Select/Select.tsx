...
const Select:React.FC<SelectProps> = ({onOptionSelected:handler , options = [], label='color', renderOption}) => {
...
if(event.keyCode === KEY_CODES.ENTER){
  ...
  return (
    <div className='dse-select'>
      ...
      <svg className={ `h-5 w-5 dse-select__caret ${isOpen ? 'dse-select__caret--open' : 'dse-select__caret--closed'}`} width='1rem' height='1rem' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
...
const renderOptionProps = {
    option, isSelected, getOptionRecommendedProps: (overrideProps={}) => {
        return {
            ref,
            role: 'menuitemradio',
           ...
           key: option.value,
            ...overrideProps
             ...
             return <li  
            {...renderOptionProps.getOptionRecommendedProps()}><Text>{option.label}</Text>
