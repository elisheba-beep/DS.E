...
const Select = ({ onOptionSelected: handler, options = [], label = 'color', renderOption }) => {
    ...
    return (React.createElement("div", { className: 'dse-select' },
        React.createElement("button", { "data-testid": 'DseSelectButton', onKeyDown: onButtonKeyDown, "aria-controls": 'dse-select-list', "aria-haspopup": true, "aria-expanded": isOpen ? true : undefined, ref: labelRef, className: 'dse-select__label', onClick: () => onLabelClick() },
            ...
            React.createElement("svg", { className: `h-5 w-5 dse-select__caret ${isOpen ? 'dse-select__caret--open' : 'dse-select__caret--closed'}`, width: '1rem', height: '1rem', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 20 20", fill: "currentColor" },
